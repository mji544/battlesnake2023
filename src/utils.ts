...
export function distanceFromCoodToClosestOpponent(gameState: GameState, coord: Coord): number {
    ...
    for (let snake of snakes) {
        ...
        let currentDistance = distanceFromCoordToOpponentHead(snake, coord);
